...
class TenderResourceTest(BaseTenderWebTest):
    ...
    def test_docs(self):
        ...
        with open(TARGET_DIR + 'tutorial/tender-listing-no-auth.http', 'w') as self.app.file_obj:
            self.app.authorization = None
            response = self.app.get(request_path)
            self.assertEqual(response.status, '200 OK')
        ...
        self.app.authorization = ('Basic', ('broker', ''))
        with open(TARGET_DIR + 'tutorial/update-tender-after-enqiery.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/ask-question-after-enquiry-period.http', 'w') as self.app.file_obj:
            response = self.app.post_json('/tenders/{}/questions'.format(
                self.tender_id), question, status=403)
            self.assertEqual(response.status, '403 Forbidden')

        with open(TARGET_DIR + 'tutorial/update-tender-after-enqiery-with-update-periods.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/upload-bid-private-proposal.http', 'w') as self.app.file_obj:
            response = self.app.post('/tenders/{}/bids/{}/documents?acc_token={}'.format(
        ...
        with open(TARGET_DIR + 'tutorial/mark-bid-doc-private.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/upload-bid-financial-document-proposal.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/bidder-financial-documents.http', 'w') as self.app.file_obj:
            response = self.app.get('/tenders/{}/bids/{}/financial_documents?acc_token={}'.format(
                    self.tender_id, bid1_id, bids_access[bid1_id]))
            self.assertEqual(response.status, '200 OK')


        with open(TARGET_DIR + 'tutorial/upload-bid-eligibility-document-proposal.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/upload-bid-qualification-document-proposal.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/bidder-view-financial-documents.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/bidder-after-changing-tender.http', 'w') as self.app.file_obj:
            response = self.app.get('/tenders/{}/bids/{}?acc_token={}'.format(
                    self.tender_id, bid1_id, bids_access[bid1_id]))
            self.assertEqual(response.status, '200 OK')
        ...
        with open(TARGET_DIR + 'tutorial/bidder-activate-after-changing-tender.http', 'w') as self.app.file_obj:
            response = self.app.patch_json('/tenders/{}/bids/{}?acc_token={}'.format(
                    self.tender_id, bid1_id, bids_access[bid1_id]), {'data': {"status": "pending"}})
            self.assertEqual(response.status, '200 OK')

        # with open(TARGET_DIR + 'tutorial/bidder-after-activate-bid-tender.http', 'w') as self.app.file_obj:
        #     response = self.app.get('/tenders/{}/bids/{}?acc_token={}'.format(
        #             self.tender_id, bid1_id, bids_access[bid1_id]))
        #     self.assertEqual(response.status, '200 OK')
        ...
        with open(TARGET_DIR + 'tutorial/register-3rd-bidder.http', 'w') as self.app.file_obj:
            for document in bid3['data']['documents']:
                document['url'] = self.generate_docservice_url()
            for document in bid3['data']['eligibilityDocuments']:
                document['url'] = self.generate_docservice_url()
        ...
        with open(TARGET_DIR + 'tutorial/qualifications-listing.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/approve-qualification1.http', 'w') as self.app.file_obj:
            ...
            self.assertEqual(response.status, "200 OK")
        with open(TARGET_DIR + 'tutorial/approve-qualification2.http', 'w') as self.app.file_obj:
            response = self.app.patch_json('/tenders/{}/qualifications/{}?acc_token={}'.format(self.tender_id, qualifications[1]['id'],
                                                                                               owner_token), {"data": {"status": "active", "qualified": True, "eligible": True}})
            self.assertEqual(response.status, "200 OK")

        with open(TARGET_DIR + 'tutorial/reject-qualification3.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/qualificated-bids-view.http', 'w') as self.app.file_obj:
            response = self.app.get('/tenders/{}/bids?acc_token={}'.format(
                    self.tender_id, owner_token))
            self.assertEqual(response.status, "200 OK")

        with open(TARGET_DIR + 'tutorial/rejected-bid-view.http', 'w') as self.app.file_obj:
            response = self.app.get('/tenders/{}/bids/{}?acc_token={}'.format(
        ...
        with open(TARGET_DIR + 'tutorial/pre-qualification-confirmation.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/tender-contract-patch-document.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/tender-contract-get.http', 'w') as self.app.file_obj:
            response = self.app.get('/tenders/{}/contracts/{}?acc_token={}'.format(
                self.tender_id, self.contract_id, owner_token))
            self.assertEqual(response.status, '200 OK')
    ...
    def test_complaints(self):
        ...
        with open(TARGET_DIR + 'tutorial/complaint-submission.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/complaint-submission-upload.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/complaint-claim.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/complaint-submission-claim.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/complaint-submission-complaint.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/complaint-complaint.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/complaint-answer.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/complaint-satisfy.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/complaint-escalate.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/complaint-reject.http', 'w') as self.app.file_obj:
            response = self.app.patch_json('/tenders/{}/complaints/{}'.format(self.tender_id, complaint4_id), {"data": {
                "status": "invalid"
            }})
            self.assertEqual(response.status, '200 OK')

        with open(TARGET_DIR + 'tutorial/complaint-accept.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/complaint-resolution-upload.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/complaint-resolve.http', 'w') as self.app.file_obj:
            response = self.app.patch_json('/tenders/{}/complaints/{}'.format(self.tender_id, complaint1_id), {"data": {
                "status": "satisfied"
            }})
            self.assertEqual(response.status, '200 OK')

        with open(TARGET_DIR + 'tutorial/complaint-decline.http', 'w') as self.app.file_obj:
            response = self.app.patch_json('/tenders/{}/complaints/{}'.format(self.tender_id, complaint3_id), {"data": {
                "status": "declined"
            }})
            self.assertEqual(response.status, '200 OK')

        with open(TARGET_DIR + 'tutorial/complaint-accepted-stopped.http', 'w') as self.app.file_obj:
            response = self.app.patch_json('/tenders/{}/complaints/{}'.format(self.tender_id, complaint5_id), {"data": {
        ...
        self.app.authorization = ('Basic', ('broker', ''))
        with open(TARGET_DIR + 'tutorial/complaint-resolved.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/complaint-accepted-stopping.http', 'w') as self.app.file_obj:
        ...
        self.app.authorization = ('Basic', ('reviewer', ''))
        with open(TARGET_DIR + 'tutorial/complaint-stopping-stopped.http', 'w') as self.app.file_obj:
            response = self.app.patch_json('/tenders/{}/complaints/{}'.format(self.tender_id, complaint6_id), {"data": {
                "decision": "Тендер скасовується замовником",
                "status": "stopped"
            }})
        ...
        with open(TARGET_DIR + 'tutorial/complaint-cancel.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/complaints-list.http', 'w') as self.app.file_obj:
            self.app.authorization = None
            response = self.app.get('/tenders/{}/complaints'.format(self.tender_id))
            self.assertEqual(response.status, '200 OK')

        with open(TARGET_DIR + 'tutorial/complaint.http', 'w') as self.app.file_obj:
            self.app.authorization = None
    ...
    def test_qualification_complaints(self):
        ...
        with open(TARGET_DIR + 'tutorial/qualification-complaint-submission.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/qualification-complaint-submission-upload.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/qualification-complaint-complaint.http', 'w') as self.app.file_obj:
        ...
        complaint_data = {'data': complaint['data'].copy()}
        complaint_data['data']['status'] = 'pending'
        with open(TARGET_DIR + 'tutorial/qualification-complaint-submission-complaint.http', 'w') as self.app.file_obj:
        ...
        claim = {'data': complaint['data'].copy()}
        claim['data']['status'] = 'claim'
        with open(TARGET_DIR + 'tutorial/qualification-complaint-submission-claim.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/qualification-complaint-answer.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/qualification-complaint-satisfy.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/qualification-complaint-unsatisfy.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/qualification-complaint-claim.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/qualification-complaint-cancel.http', 'w') as self.app.file_obj:
            response = self.app.patch_json('/tenders/{}/qualifications/{}/complaints/{}?acc_token={}'.format(self.tender_id, qualification_id, response.json['data']['id'], response.json['access']['token']), {"data": {
                "cancellationReason": "Умови виправлено",
                "status": "cancelled"
            }})
        ...
        self.app.authorization = ('Basic', ('reviewer', ''))
        with open(TARGET_DIR + 'tutorial/qualification-complaint-reject.http', 'w') as self.app.file_obj:
            response = self.app.patch_json('/tenders/{}/qualifications/{}/complaints/{}'.format(self.tender_id, qualification_id, complaint2_id), {"data": {
                "status": "invalid"
            }})
            self.assertEqual(response.status, '200 OK')

        with open(TARGET_DIR + 'tutorial/qualification-complaint-accept.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/qualification-complaint-resolution-upload.http', 'w') as self.app.file_obj:
            response = self.app.post('/tenders/{}/qualifications/{}/complaints/{}/documents'.format(self.tender_id, qualification_id, complaint1_id),
                                     upload_files=[('file', u'ComplaintResolution.pdf', 'content')])
            self.assertEqual(response.status, '201 Created')

        with open(TARGET_DIR + 'tutorial/qualification-complaint-resolve.http', 'w') as self.app.file_obj:
            response = self.app.patch_json('/tenders/{}/qualifications/{}/complaints/{}'.format(self.tender_id, qualification_id, complaint1_id), {"data": {
                "status": "satisfied"
            }})
            self.assertEqual(response.status, '200 OK')

        with open(TARGET_DIR + 'tutorial/qualification-complaint-decline.http', 'w') as self.app.file_obj:
            response = self.app.patch_json('/tenders/{}/qualifications/{}/complaints/{}'.format(self.tender_id, qualification_id, complaint3_id), {"data": {
                "status": "declined"
            }})
            self.assertEqual(response.status, '200 OK')

        with open(TARGET_DIR + 'tutorial/qualification-complaint-accepted-stopped.http', 'w') as self.app.file_obj:
            response = self.app.patch_json('/tenders/{}/qualifications/{}/complaints/{}'.format(self.tender_id, qualification_id, complaint5_id), {"data": {
                "decision": "Тендер скасовується замовником",
                "status": "stopped"
            }})
        ...
        self.app.authorization = ('Basic', ('broker', ''))
        with open(TARGET_DIR + 'tutorial/qualification-complaint-resolved.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/qualification-complaint-accepted-stopping.http', 'w') as self.app.file_obj:
        ...
        self.app.authorization = ('Basic', ('reviewer', ''))
        with open(TARGET_DIR + 'tutorial/qualification-complaint-stopping-stopped.http', 'w') as self.app.file_obj:
            response = self.app.patch_json('/tenders/{}/qualifications/{}/complaints/{}'.format(self.tender_id, qualification_id, complaint4_id), {"data": {
                "decision": "Тендер скасовується замовником",
                "status": "stopped"
            }})
        ...
        self.app.authorization = None
        with open(TARGET_DIR + 'tutorial/qualification-complaints-list.http', 'w') as self.app.file_obj:
            response = self.app.get('/tenders/{}/qualifications/{}/complaints'.format(self.tender_id, qualification_id))
            self.assertEqual(response.status, '200 OK')

        with open(TARGET_DIR + 'tutorial/qualification-complaint.http', 'w') as self.app.file_obj:
    ...
    def test_award_complaints(self):
        ...
        claim = {'data': complaint['data'].copy()}
        claim['data']['status'] = 'claim'
        with open(TARGET_DIR + 'tutorial/award-complaint-submission-claim.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/award-complaint-answer.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/award-complaint-satisfy.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/award-complaint-unsatisfy.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'tutorial/award-complaint-claim.http', 'w') as self.app.file_obj:
    ...
    def test_multiple_lots(self):
        ...
        self.app.authorization = ('Basic', ('broker', ''))
        with open(TARGET_DIR + 'multiple_lots_tutorial/bid-lot1.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'multiple_lots_tutorial/bid-lot2.http', 'w') as self.app.file_obj:
            response = self.app.post_json('/tenders/{}/bids'.format(tender_id),
                {'data': {'selfEligible': True, 'selfQualified': True,
        ...
        with open(TARGET_DIR + 'multiple_lots_tutorial/tender-invalid-all-bids.http', 'w') as self.app.file_obj:
            response = self.app.patch_json('/tenders/{}/lots/{}?acc_token={}'.format(tender_id, lot_id2, owner_token), {'data': {'value': {'amount': 400}}})
            self.assertEqual(response.status, '200 OK')

        with open(TARGET_DIR + 'multiple_lots_tutorial/bid-lot1-invalid-view.http', 'w') as self.app.file_obj:
            response = self.app.get('/tenders/{}/bids/{}?acc_token={}'.format(tender_id, bid1_id, bid1_token))
            self.assertEqual(response.status, '200 OK')

        with open(TARGET_DIR + 'multiple_lots_tutorial/bid-lot1-update-view.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'multiple_lots_tutorial/bid-lot2-update-view.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'multiple_lots_tutorial/tender-view-pre-qualification.http', 'w') as self.app.file_obj:
            response = self.app.get('/tenders/{}?acc_token={}'.format(tender_id, owner_token))
            self.assertEqual(response.status, '200 OK')

        with open(TARGET_DIR + 'multiple_lots_tutorial/qualifications-view.http', 'w') as self.app.file_obj:
            response = self.app.get('/tenders/{}/qualifications?acc_token={}'.format(self.tender_id, owner_token))
            self.assertEqual(response.content_type, 'application/json')
            qualifications = response.json['data']


        with open(TARGET_DIR + 'multiple_lots_tutorial/tender-activate-qualifications.http', 'w') as self.app.file_obj:
        ...
        with open(TARGET_DIR + 'multiple_lots_tutorial/tender-view-pre-qualification-stand-still.http', 'w') as self.app.file_obj:
